...
#+begin_src emacs-lisp
  (dolist (package '(cider flycheck kibit-mode autoinsert visual-regexp
                           ...
                           ess r-autoyas gist expand-region multiple-cursors ox-reveal
...
#+begin_src emacs-lisp
 (require 'dired-x)
  ...
  (dolist (ext '("pyg" "fls" "fdb_latexmk"))
    (add-to-list 'dired-omit-extensions  (concat "." ext)))
...
#+begin_src emacs-lisp
  ...
  (defun my-latex-ref-to-cref (contents backend info)
    "Org export filter to allow use cref
     in latex org export. Require use of cleveref"
